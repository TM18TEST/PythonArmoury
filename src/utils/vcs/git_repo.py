...
# -*- coding: utf-8 -*-
"""
Description: Git Repositoty Class Source Code.
"""
...
class GitRepo:
    ...
    def clone(self):
        ...
        try:
            ...
            Repo.clone_from(remote_url, self.local_repo_path)
    ...
    @staticmethod
    def _has_changes_to_commit(r: Repo) -> bool:
    ...
    def _has_commit(self, repo: Repo) -> bool:
    ...
    def _initial_commit(self, repo: Repo, msg: str):
    ...
    def _has_remote_branches(self, repo: Repo) -> bool:
    ...
    def _find_commit_by_timestamp(self, repo: Repo, commit_time: datetime, branch_name: str):
